    ...
    <div className="flex flex-col md:flex-row space-y-4 space-x-0 md:space-y-0 md:space-x-6 md:items-center">
      <form onSubmit={handleSubmit}>
        <div className="flex">
          ...
          />
          <button className=" rounded-r-lg w-16 bg-slate-900">Go</button>
        </div>
      </form>
      {users.length > 0 && (
        <div>
          <button className="text-sm font-bold font-serif text-white bg-red-700 hover:bg-red-900 rounded-lg px-2 py-1">
            Clear
          </button>
        </div>
      )}
